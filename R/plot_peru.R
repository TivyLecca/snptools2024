plot_peru = function (xlim = c(-86, -70), ylim = c(-21, -3), xlab = "", ylab = "",
                      hadj = 0.5, padj = 0.5, cex_axis = 1, cex_harbor = 1, col_harbor = 1,
                      font_harbor = 2, land.col = "khaki1", border.map = "khaki1",
                      add1 = FALSE, n_perfil = 1, space_perfil = 3, area_iso = FALSE,
                      name_area_iso = NULL)
{
  require(maps)
  require(mapdata)
  ...
  if(isTRUE(area_iso)){
    ...
    agregar_isoparalitoral(dataIsopara = lonlat_areaIso, ylim = c(-21, -3))
    lines(linePeru$lon, linePeru$lat, col = "gray40")
  }
